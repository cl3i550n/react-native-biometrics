...
export module ReactNativeBiometricsLegacy {
   ...
   */
  export function isSensorAvailable(options?: { promptForEnrollment?: boolean }): Promise<IsSensorAvailableResult> {
...
export default class ReactNativeBiometrics {
   ...
   * @returns {Promise<Object>} Promise that resolves to an object with details about biometrics available
   */
  isSensorAvailable(options?: { promptForEnrollment?: boolean }): Promise<IsSensorAvailableResult> {
